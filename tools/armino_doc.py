...
def build_armino_doc(source_path, dest_path, build_path, landir, version):
	...
	run_cmd(f'cp -rf {build_path}/{landir}/latex/DashcamDocument.pdf {build_path}/{landir}/{version}/DashcamDocument.pdf')
...
def build_html(source_path, dest_path, build_path, landir):
	...
	#copy
	run_cmd(f'cp -rf {dest_path} {build_path}/{landir}')
	#run_cmd(f'cp -rf {build_path}/{landir}/latex/DashcamDocument.pdf {build_path}/{landir}/DashcamDocument.pdf')
