...
Armino Dashcam SDK代码下载
------------------------------------

您可从 gitlab 上下载 Armino Dashcam SDK::
...
在终端下输入下述命令编译 Armino Dashcam默认工程，PROJECT为可选参数，默认为scooter::

    cd ~/armino/bk_dashcam
    make bk7258

您也可以通过 PROJECT 参数来编译 projects 下其他工程，如 make bk7258 PROJECT=scooter
可以编译 projects/scooter 工程。
...
BK7258 默认工程为 projects/scooter，新建工程可参考 projects 下面的其他工程
