...
{
    var url = "/arminodoc/versioncfg/bk_dashcam/version.json";
...
function setPageStyle()
{
    ...
    var stylePage = `
        <a href="DashcamDocument.pdf" download="DashcamDocument.pdf"><img src="_static/pdf.png" style="width: 24px; height: 24px; display: inline; align-items: center; cursor: pointer; margin-left:5px"/></a>
